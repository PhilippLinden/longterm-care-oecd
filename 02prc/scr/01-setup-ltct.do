/*==============================================================================
File name: 		00-setup-ltct.do
Task:			Longterm care typology - Setup the dataset
...
import excel "$rdta/20200116_coelcare_ma_Typology_Indicators_Data.xlsx", sheet("LTC expenditure, health") firstrow
...
save "$pdta\LTCT_LTC_he.dta", replace
...
import excel "$rdta/20200116_coelcare_ma_Typology_Indicators_Data.xlsx", sheet("LTC residental beds") firstrow
...
save "$pdta\LTCT_LTC_beds.dta", replace
...
import excel "$rdta/20200116_coelcare_ma_Typology_Indicators_Data.xlsx", sheet("LTC recipients institutions") firstrow
...
save "$pdta\LTCT_LTC_inst.dta", replace
...
import excel "$rdta/20200116_coelcare_ma_Typology_Indicators_Data.xlsx", sheet("Share of private exp (health)") firstrow
...
save "$pdta\LTCT_priv_he.dta", replace
...
import excel "$rdta/20200116_coelcare_ma_Typology_Indicators_Data.xlsx", sheet("Life expectancy") cellrange(D85:X120)
...
save "$pdta\LTCT_life_exp.dta", replace
...
import excel "$rdta/20200116_coelcare_ma_Typology_Indicators_Data.xlsx", sheet("Perceived health status") cellrange(E78:X113)
...
save "$pdta\LTCT_perc_he.dta", replace
...
import excel "$rdta/20200116_coelcare_ma_Typology_Indicators_Data.xlsx", sheet("Overview Quali checked") firstrow
...
compress
save "$pdta\LTCT_aux.dta", replace
...
clear all
use "$pdta\LTCT_LTC_he.dta"
keep id LTC_he
save "$pdta\LTCT_LTC_he_aux.dta", replace

clear all
use "$pdta\LTCT_priv_he.dta"
keep id priv_he
save "$pdta\LTCT_priv_he_aux.dta", replace

clear all
use "$pdta\LTCT_LTC_inst.dta"
keep id LTC_inst
save "$pdta\LTCT_LTC_inst_aux.dta", replace

clear all
use "$pdta\LTCT_LTC_beds.dta"
keep id LTC_beds
save "$pdta\LTCT_LTC_beds_aux.dta", replace

clear all
use "$pdta\LTCT_life_exp.dta"
keep id life_exp
save "$pdta\LTCT_life_exp_aux.dta", replace

clear all
use "$pdta\LTCT_perc_he.dta"
keep id perc_he
save "$pdta\LTCT_perc_he_aux.dta", replace

clear all
use "$pdta\LTCT_aux.dta"
	merge 1:1 id using "$pdta\LTCT_LTC_he_aux.dta"
		drop _merge
	merge 1:1 id using "$pdta\LTCT_priv_he_aux.dta"
		drop _merge
	merge 1:1 id using "$pdta\LTCT_LTC_inst_aux.dta"
		drop _merge		
	merge 1:1 id using "$pdta\LTCT_LTC_beds_aux.dta"
		drop _merge
	merge 1:1 id using "$pdta\LTCT_life_exp_aux.dta"
		drop _merge
	merge 1:1 id using "$pdta\LTCT_perc_he_aux.dta"
		drop _merge

order id country LTC_he - perc_he cash_avail home_care - cash_vs_inkind means_any

erase "$pdta\LTCT_LTC_he.dta"
erase "$pdta\LTCT_priv_he.dta"
erase "$pdta\LTCT_LTC_inst.dta"
erase "$pdta\LTCT_LTC_beds.dta"
erase "$pdta\LTCT_life_exp.dta"
erase "$pdta\LTCT_perc_he.dta"
erase "$pdta\LTCT_LTC_he_aux.dta"
erase "$pdta\LTCT_priv_he_aux.dta"
erase "$pdta\LTCT_LTC_inst_aux.dta"
erase "$pdta\LTCT_LTC_beds_aux.dta"
erase "$pdta\LTCT_life_exp_aux.dta"
erase "$pdta\LTCT_perc_he_aux.dta"
...
compress
save "$pdta\LTCT_Prep.dta", replace
erase "$pdta\LTCT_aux.dta"
